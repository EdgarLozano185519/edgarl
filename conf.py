...
BLOG_AUTHOR = "Edgar Lozano"  # (translatable)
BLOG_TITLE = "Edgar's Personal Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://edgarl.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://edgarl.com/"
BLOG_EMAIL = "edgar@edgarl.com"
BLOG_DESCRIPTION = "This is Edgar Lozano's personal website containing programming projects, blog entries, and other things of interest."  # (translatable)
...
DATE_FORMAT = 'EEEE, MMMM d, yyyy h:mm a'
